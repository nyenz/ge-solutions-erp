...
public class BacklogSchedulerTest {

    @Autowired
    private BacklogSchedulerService backlogSchedulerService;
    ...
    public void testDailyStorageFeeLifecycle() throws Exception {
        ...
        // ── STEP 1: Create a plot in backlog, started 35 days ago ──────────────
        ...
        LandProject project = LandProject.builder()
                ...
                .isBacklog(true)
                .backlogStartDate(LocalDateTime.now().minusDays(35))
                .storageFeesAccumulated(BigDecimal.ZERO)
                .backlogMonthsBilled(0)
                .storagePaused(false)
                .status("BACKLOG")
                .build();
        ...
        backlogSchedulerService.applyMonthlyStorageFees();
        ...
        assertEquals(1, afterStep2.getBacklogMonthsBilled(),
                "Step 2: Expected backlogMonthsBilled = 1");

        // ── STEP 3: Time-travel to 65 days ago, set custom rate of 75,000 ─────
        afterStep2.setBacklogStartDate(LocalDateTime.now().minusDays(65));
        afterStep2.setBacklogMonthsBilled(1);
        ...
        assertEquals(2, afterStep4.getBacklogMonthsBilled(),
                "Step 4: Expected backlogMonthsBilled = 2");

        // ── STEP 5: Set a negotiation deadline in the future ──────────────────
        afterStep4.setNegotiationDeadline(LocalDateTime.now().plusDays(2));
        afterStep4.setBacklogStartDate(LocalDateTime.now().minusDays(95));
        ...
        assertEquals(2, afterStep6.getBacklogMonthsBilled(),
